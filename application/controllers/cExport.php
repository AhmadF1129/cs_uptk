...
class cExport extends CI_Controller
{
	...
	public function exportPDF()
	{
		...
		$pdf->SetCreator('UPTK-POLBAN');
		$pdf->SetAuthor('UPTK-POLBAN');
		...
		$info = '
				...
				<p>
					<strong>FILTER BY</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : ' . $_POST['filterBy'] . '
				</p>
				<p>
	...
	public function exportXLS()
	{
		...
		$logo->setName('LOGO POLBAN');
		$logo->setDescription('LOGO');
		$logo->setPath('assets\IMAGES\polban.png');
		...
		// HEADER - TITLE 
		$spreadsheet->getActiveSheet()->setCellValue('C2', 'POLITEKNIK NEGERI BANDUNG');
		$spreadsheet->getActiveSheet()->setCellValue('C3', 'LAPORAN');
		$spreadsheet->getActiveSheet()->setCellValue('C4', 'LAYANAN UPTK - POLBAN');
		...
		$spreadsheet->getActiveSheet()->setCellValue('B7', 'FILTER BY');
		$spreadsheet->getActiveSheet()->setCellValue('C7', ': ' . $_POST['filterBy']);
		$spreadsheet->getActiveSheet()->setCellValue('B8', 'PADA');
		$spreadsheet->getActiveSheet()->setCellValue('C8',  ': ' . $_POST['padaWaktu']);
		$spreadsheet->getActiveSheet()->getStyle('B6:B8')->applyFromArray($styleArray['headerInfo']);
