...
class myTCPDF extends TCPDF
{
    ...
    {
        // Get Image
        $image_file = '<img src="' . K_PATH_IMAGES . 'polban.png' . '" height="75" width="auto">';
        ...
        $setHeader = '
            <table>
                <tr>
                    ...
                    <td width="85%"><h1>POLITEKNIK NEGERI BANDUNG</h1></td>
                </tr>
                <tr>
                    <td style="font-size:15px" width="85%">LAPORAN</td>
                </tr>
                <tr>
                    <td style="font-size:15px" width="85%">LAYANAN UPTK - POLBAN</td>
                </tr>
            </table>
            <br>
            <hr>';
