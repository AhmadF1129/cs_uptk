        ...
        <div class="col">
            ...
            <div class="form-row">
                <div class="form-group col-md-8">
                    <div id="search_area">
                        <input type="text" id="search-data-history" name="search-data-history" placeholder="Search" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    <div class="float-right">
                        <button class="btn btn-success" title="EXPORT" href="#modal-export-history" data-toggle="modal">
                            EXPORT
                        </button>
                    </div>
                </div>
